...
void Earthquake::handle() {
    ...
    A_Star(modified_road_network, HOSPITAL, damaged_node, shortest_path, emergency_routes[0]);
    A_Star(modified_road_network, POLICE_STATION, damaged_node, shortest_path, emergency_routes[1]);
    A_Star(modified_road_network, FIRE_STATION, damaged_node, shortest_path, emergency_routes[2]);
